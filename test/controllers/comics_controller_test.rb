...
class ComicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comic" do
    assert_difference('Comic.count') do
      post comics_url, params: { comic: { author: @comic.author, overview: @comic.overview, seriazation_status: @comic.seriazation_status, title: @comic.title } }
    end
  ...
  test "should update comic" do
    patch comic_url(@comic), params: { comic: { author: @comic.author, overview: @comic.overview, seriazation_status: @comic.seriazation_status, title: @comic.title } }
